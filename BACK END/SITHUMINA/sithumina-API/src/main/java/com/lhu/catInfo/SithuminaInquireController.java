...
public class SithuminaInquireController {
	...
	public Object[] getAllInq() {
		System.out.println("/all-inquiry : ServByte, Inc");
		Object[] respose = {};
		try {	
			...
			System.out.println("FAILED TO GET INQUIRIES | ServByte, Inc..");
		}		
		return respose;
	}
	...
	public int createNewInq(@PathVariable("inqDesc") String inqDesc,@PathVariable("userId") int userId) {	
		System.out.println("ServByte, Inc : /add-inquiry/{inqDesc}/{userId}");
		int respose = 0;
		try {
			...
			System.out.println("FAILED TO CREATE NEW INQUIRY | ServByte, Inc..");
		}		
		return respose;
	}
