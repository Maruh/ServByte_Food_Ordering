...
public class SithuminaTranController {
	...
	public Object[] getCategories() {
		...
		try {	
			...
			System.out.println("FAILED TO GET TRANSACTION | ServByte, Inc..");
		}		
		return respose;
	}
	...
	public int getCategory(@PathVariable("tranAmount") String tranAmount, @PathVariable("cartId") int cartId) {
		System.out.println("ServByte, Inc : /add-transaction/{tranAmount}/{cartId}");
		int respose = 0;
		try {
			...
			System.out.println("FAILED TO ADD TRANSACTION | ServByte, Inc..");
		}		
		return respose;
	}
