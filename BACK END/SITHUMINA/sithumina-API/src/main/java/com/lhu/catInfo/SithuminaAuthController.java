...
public class SithuminaAuthController {
	...
	public Object[] getCategories() {
		System.out.println("/uers : ServByte, Inc");
		Object[] respose = {};
		try {	
			...
			System.out.println("FAILED TO GET USERS | ServByte, Inc..");
		}		
		return respose;
	}
	...
	public int userRegister(@PathVariable("userName") String userName,@PathVariable("userPassword") String userPassword,@PathVariable("userType") String userType) {	
		System.out.println("ServByte, Inc : /uer-register/{userName}/{userPassword}/{userType}");
		int respose = 0;
		try {
			...
			System.out.println("FAILED TO REGISTER USER | ServByte, Inc..");
		}		
		return respose;
	}
	...
	public Object userLogin(@PathVariable("userName") String userName,@PathVariable("userPassword") String userPassword) {	
		System.out.println("ServByte, Inc : /uers");
		...
		try {	
			...
			System.out.println("FAILED TO USER LOG IN | ServByte, Inc..");
		}		
		return respose;
	}
